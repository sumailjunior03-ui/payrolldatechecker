...
(function () {
  ...
  window.CALC_HQ_NETWORK = [
    ...
    { name: "PayrollDateChecker.com",       url: "https://salaryvsinflation.com",    live: true,  clusters: ["us", "tax-income"] },
  ...
  function renderFooter() {
    ...
    footerTarget.innerHTML = [
      ...
      '</div>',
      '<p class="footer-meta">PayrollDateChecker.com · Estimates run locally in your browser.</p>'
    ].join('');
  }
